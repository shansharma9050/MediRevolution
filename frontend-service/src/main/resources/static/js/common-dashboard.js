...
function applyBillingMenu() {
    ...
    if (tenantType === "WHOLESALER") {
        ...
        document
            .querySelectorAll(".saas-wholesaler-only")
            .forEach(item => item.style.display = "");

    }

    else if (tenantType === "RETAILER") {

        document
            .querySelectorAll(".saas-retailer-only")
            .forEach(item => item.style.display = "");
        ...
        document
            .querySelectorAll(".saas-hospital-only")
            .forEach(item => item.style.display = "");

    }

    else if (tenantType === "DOCTOR") {

        document
            .querySelectorAll(".saas-doctor-only")
            .forEach(item => item.style.display = "");
