...
public interface SaasIpdAdmissionRepository
        extends JpaRepository<SaasIpdAdmission, Long> {

    List<SaasIpdAdmission>
            findByTenantIdAndActiveTrueOrderByAdmissionDateTimeDesc(
                    Long tenantId
            );

    Optional<SaasIpdAdmission>
    ...
    List<SaasIpdAdmission>
            findByTenantIdAndDoctorProfileIdAndActiveTrueOrderByAdmissionDateTimeDesc(
                    Long tenantId,
    ...
    /*
     * Patient cannot have two simultaneous active admissions.
     */

    boolean existsByTenantIdAndPatientIdAndStatusAndActiveTrue(
            Long tenantId,
            Long patientId,
