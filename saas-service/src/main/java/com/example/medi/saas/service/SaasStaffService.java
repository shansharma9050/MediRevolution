...
public class SaasStaffService {
    ...
    public List<SaasStaffResponse> getDoctorsAsStaff(Long tenantId) {
        ...
        /*
         * Doctor list can be used by appointment and availability pages.
         * STAFF VIEW permission is enough because doctors are staff records.
         */
        permissionService.requirePermission(
                tenantId,
                TenantModule.STAFF,
        ...
        return staffRepository
                .findByTenantIdAndStaffRoleAndActiveTrueOrderByStaffNameAsc(
                        tenantId,
    ...
    public SaasStaffResponse getStaffById(Long tenantId, Long staffId) {
        ...
        SaasStaff staff = staffRepository
                .findByIdAndTenantIdAndActiveTrue(staffId, tenantId)
    ...
    public List<SaasStaffResponse> searchStaff(Long tenantId, String keyword) {
        ...
        result.addAll(
                staffRepository
                        .findByTenantIdAndActiveTrueAndStaffNameContainingIgnoreCaseOrderByCreatedAtDesc(
                                tenantId,
                                cleanKeyword
                        )
        );
    ...
    public SaasStaffResponse updateStaff(Long tenantId, Long staffId, SaasStaffRequest request) {
        ...
        /*
         * Important:
         * Do not overwrite authUserId with null during update.
         */
        if (request.getAuthUserId() != null) {
        ...
        /*
         * Sync tenant member name/email/mobile/role.
         * Do not reset custom permissions on update.
         */
    ...
    private void applyRequestToStaff(SaasStaff staff, SaasStaffRequest request) {
        ...
        SaasStaffRole staffRole = SaasStaffRole.valueOf(request.getStaffRole().toUpperCase());
    ...
    private Long resolveStaffAuthUserId(SaasStaffRequest request) {
        ...
        AuthUserResponse authUser = authClient.createSaasStaff(
                authorization,
                authRequest
        );
    ...
    private void syncTenantMemberForStaff(SaasStaff staff, boolean assignDefaultPermissions) {
        ...
        TenantMember member = tenantMemberRepository
                .findByTenantIdAndAuthUserIdAndActiveTrue(staff.getTenantId(), staff.getAuthUserId())
                .orElse(null);
