...
public class SaasWorkspaceDeletionService {
    ...
    private final SaasPatientDocumentRepository patientDocumentRepository;

    private final SaasPatientAllergyRepository patientAllergyRepository;

    private final SaasPatientMergeRepository patientMergeRepository;

    private final SaasPatientRepository patientRepository;

    private final SaasPatientDocumentTenantCleanupService
            patientDocumentTenantCleanupService;
    ...
    public SaasWorkspaceDeletionService(
            ...
            SaasPatientDocumentRepository patientDocumentRepository,

            SaasPatientAllergyRepository patientAllergyRepository,

            SaasPatientMergeRepository patientMergeRepository,

            SaasPatientRepository patientRepository,

            SaasPatientDocumentTenantCleanupService
                    patientDocumentTenantCleanupService
    ) {
        ...
        this.tenantModuleSettingRepository =
                tenantModuleSettingRepository;

        this.tenantMemberPermissionRepository =
                tenantMemberPermissionRepository;
        ...
        this.ipdDailyNoteRepository =
                ipdDailyNoteRepository;

        this.ipdChargeRepository =
                ipdChargeRepository;
        ...
        this.diagnosticOrderItemRepository =
                diagnosticOrderItemRepository;

        this.diagnosticOrderRepository =
                diagnosticOrderRepository;

        this.diagnosticTestRepository =
                diagnosticTestRepository;


        this.paymentReceiptRepository =
        ...
        this.pharmacySaleItemRepository =
                pharmacySaleItemRepository;

        this.pharmacySaleRepository =
                pharmacySaleRepository;


        this.salesReturnItemRepository =
                salesReturnItemRepository;

        this.salesReturnRepository =
                salesReturnRepository;


        this.saleStockAllocationRepository =
                saleStockAllocationRepository;
        ...
        this.salesOrderTimelineRepository =
                salesOrderTimelineRepository;
        ...
        this.purchaseReturnItemRepository =
        ...
        this.expiryActionRepository =
                expiryActionRepository;

        this.stockMovementRepository =
                stockMovementRepository;

        this.medicineStockRepository =
        ...
        this.partyLedgerEntryRepository =
        ...
        this.wholesalerInvoiceItemRepository =
                wholesalerInvoiceItemRepository;

        this.wholesalerInvoiceRepository =
                wholesalerInvoiceRepository;
        ...
        this.patientDocumentRepository =
                patientDocumentRepository;

        this.patientAllergyRepository =
                patientAllergyRepository;

        this.patientMergeRepository =
                patientMergeRepository;

        this.patientRepository =
                patientRepository;

        this.patientDocumentTenantCleanupService =
                patientDocumentTenantCleanupService;
    }
    ...
    public void deleteWorkspace(
        ...
        if (
            ...
            throw new RuntimeException(
                    "Valid SaaS workspace is required"
            );
        }
        ...
        /*
         * Only workspace owner can permanently delete it.
         */
        ...
        appointmentRepository.deleteByTenantId(
                tenantId
        );


        prescriptionMedicineRepository.deleteByTenantId(
                tenantId
        );

        prescriptionRepository.deleteByTenantId(
                tenantId
        );
        ...
        ipdDailyNoteRepository.deleteByTenantId(
                tenantId
        );

        ipdChargeRepository.deleteByTenantId(
                tenantId
        );

        ipdAdmissionRepository.deleteByTenantId(
                tenantId
        );


        opdVisitRepository.deleteByTenantId(
                tenantId
        );
        ...
        diagnosticOrderItemRepository.deleteByTenantId(
                tenantId
        );

        diagnosticOrderRepository.deleteByTenantId(
                tenantId
        );

        diagnosticTestRepository.deleteByTenantId(
                tenantId
        );
        ...
        paymentReceiptRepository.deleteByTenantId(
                tenantId
        );

        invoiceItemRepository.deleteByTenantId(
                tenantId
        );

        invoiceRepository.deleteByTenantId(
                tenantId
        );
        ...
        pharmacySaleItemRepository.deleteByTenantId(
                tenantId
        );

        pharmacySaleRepository.deleteByTenantId(
                tenantId
        );
        ...
        salesReturnItemRepository.deleteByTenantId(
                tenantId
        );

        salesReturnRepository.deleteByTenantId(
                tenantId
        );
        ...
        saleStockAllocationRepository.deleteByTenantId(
                tenantId
        );

        saleItemRepository.deleteByTenantId(
                tenantId
        );

        saleRepository.deleteByTenantId(
                tenantId
        );
        ...
        salesOrderTimelineRepository.deleteByTenantId(
                tenantId
        );

        salesOrderItemRepository.deleteByTenantId(
                tenantId
        );

        salesOrderRepository.deleteByTenantId(
                tenantId
        );
        ...
        purchaseReturnItemRepository.deleteByTenantId(
                tenantId
        );

        purchaseReturnRepository.deleteByTenantId(
                tenantId
        );
        ...
        purchaseItemRepository.deleteByTenantId(
                tenantId
        );

        purchaseRepository.deleteByTenantId(
                tenantId
        );
        ...
        expiryActionRepository.deleteByTenantId(
                tenantId
        );

        stockMovementRepository.deleteByTenantId(
                tenantId
        );

        medicineStockRepository.deleteByTenantId(
                tenantId
        );

        medicineRepository.deleteByTenantId(
                tenantId
        );
        ...
        partyLedgerEntryRepository.deleteByTenantId(
                tenantId
        );

        paymentTransactionRepository.deleteByTenantId(
                tenantId
        );
        ...
        customerRepository.deleteByTenantId(
                tenantId
        );

        supplierRepository.deleteByTenantId(
                tenantId
        );
        ...
        notificationRepository.deleteByTenantId(
                tenantId
        );
        ...
        wholesalerInvoiceItemRepository.deleteByTenantId(
                tenantId
        );

        wholesalerInvoiceRepository.deleteByTenantId(
                tenantId
        );
        ...
        doctorAvailabilityRepository.deleteByTenantId(
                tenantId
        );

        doctorScheduleRepository.deleteByTenantId(
                tenantId
        );

        doctorProfileRepository.deleteByTenantId(
                tenantId
        );
        ...
        staffRepository.deleteByTenantId(
                tenantId
        );
        ...
        bedRepository.deleteByTenantId(
                tenantId
        );

        wardRepository.deleteByTenantId(
                tenantId
        );
        ...
        /*
         * =========================================================
         * 19. PATIENT 360 CHILD / AUDIT DATA
         * =========================================================
         *
         * These must be removed before deleting patient identities.
         */

        patientDocumentRepository.deleteByTenantId(
                tenantId
        );

        patientAllergyRepository.deleteByTenantId(
                tenantId
        );

        patientMergeRepository.deleteByTenantId(
                tenantId
        );
        ...
        /*
         * =========================================================
         * 20. PATIENT IDENTITIES
         * =========================================================
         */

        patientRepository.deleteByTenantId(
                tenantId
        );
        ...
        /*
         * =========================================================
         * 21. TENANT SETTINGS / PERMISSIONS
         * =========================================================
         */

        tenantMemberPermissionRepository.deleteByTenantId(
                tenantId
        );

        tenantModuleSettingRepository.deleteByTenantId(
                tenantId
        );

        tenantSettingRepository.deleteByTenantId(
                tenantId
        );
        ...
        tenantMemberRepository.deleteByTenantId(
                tenantId
        );
        ...
        /*
         * Make DB/FK problems visible before filesystem cleanup.
         */
        ...
        /*
         * =========================================================
         * 24. PHYSICAL PATIENT DOCUMENT STORAGE
         * =========================================================
         *
         * DB is authoritative. Physical cleanup is best-effort.
         */
