...
public class HospitalController {
	...
	public HospitalInventory updateInventory(
	        @PathVariable Long id,
	        @RequestBody HospitalInventory inventory
	) {
	    return service.updateInventory(id, inventory);
	}
	
	@PutMapping("/inventory/{id}/use")
	public HospitalInventory useInventoryItem(
	        @PathVariable Long id,
	...
	public HospitalPatient updatePatient(
	        @PathVariable Long id,
	        @RequestBody HospitalPatient patient
	) {
	...
	@PutMapping("/bills/{id}")
	public HospitalBill updateBill(
	        @PathVariable Long id,
	        @RequestBody HospitalBill bill
	) {
	...
	public HospitalAppointment bookHospitalAppointment(
	        @RequestBody BookHospitalAppointmentRequest request
	) {
